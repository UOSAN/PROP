...
experiment_code='PRP';  % this should be a short (2-3 letter) code for the experiment
...
save(['output/' output_filename],'run_info','key_presses');
...
%print a report
experiment_output(['output/' output_filename],PRINT_OUTPUT); %Results will always print to screen, PRINT_OUTPUT determines whether gets saved to txt file as well
